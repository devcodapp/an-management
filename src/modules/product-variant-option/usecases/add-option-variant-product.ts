...
interface AddOptionVariantProductRequest {
  productId: string;
  variantId: string;
  title: string;
  sku?: string;
...
interface AddOptionVariantProductResponse {
  product: Product;
}
...
export class CreateProduct {
  ...
  async execute(
    request: AddOptionVariantProductRequest,
  ): Promise<AddOptionVariantProductResponse> {
